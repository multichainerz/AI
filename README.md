...
ai-v3.16.0 is a greenfield release. Use clean VM1 and VM2 installations; it intentionally refuses a pre-v3.16 database instead of attempting an unsafe in-place conversion.
