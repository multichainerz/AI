...
process.stdout.write("The bootstrap token was written to its protected secret file and was not printed.\n");
process.stdout.write("Back up the database and vault secrets securely before deployment.\n");
