...
- Current working branch: `fix/worker-run-durability` at `v0.2.0`, one commit ahead of `main`, not yet pushed. See "Latest verified build state" for what it contains.
