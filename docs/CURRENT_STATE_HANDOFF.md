...
- Existing v4.6.0 VM1 installations migrate in place; rerun the generated VM2 installer with `--repair` to install the corpus companion. Pre-v3.16 databases still require clean hosts.
