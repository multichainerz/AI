# Current State Handoff — ai-v3.20.0
...
`ai-v3.19.0` also establishes the workspace presentation baseline. Shared
...
`ai-v3.20.0` reorganises the workspace around the question each surface
...
- Existing ai-v3.16.0 and ai-v3.17.x VM1 installations update in place; rerun the current generated VM2 installer with `--repair` to install or replace the corpus companion. Pre-v3.16 databases still require clean hosts.
