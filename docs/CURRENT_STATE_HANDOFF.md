# Current State Handoff — ai-v3.17.1
...
- Existing ai-v3.16.0 and ai-v3.17.0 VM1 installations update in place; rerun the generated VM2 installer with `--repair` to install or replace the corpus companion. Pre-v3.16 databases still require clean hosts.
