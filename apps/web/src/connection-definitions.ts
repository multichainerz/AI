...
export const connectionDefinitions: ConnectionDefinition[] = [
  {
    ...
    configurationFields: [
      ...
      { name: "maxOutputTokens", label: "Maximum output tokens", type: "number", defaultValue: 2048, min: 64, max: 32768, step: 64, help: "Hard output limit AIHub applies to direct diagnostic chat." },
  ...
  },
  {
    ...
    configurationFields: [
      ...
      { name: "toolsetsPath", label: "Toolsets path", type: "text", defaultValue: "/v1/toolsets", help: "AIHub refuses governed execution if any native Hermes toolset is enabled." },
  ...
  },
  {
    ...
    configurationFields: [
      { name: "clientId", label: "Client ID", type: "text", placeholder: "aihub", help: "Application identifier registered with an OIDC provider such as Microsoft Entra ID or AD FS." },
