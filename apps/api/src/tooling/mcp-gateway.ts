import { ORCASYNAPSE_VERSION, type GovernedTool } from "@orcasynapse/contracts";
import {
  ToolingDeniedError,
...
const SERVER_INFO = { name: "orcasynapse-governed-tools", version: ORCASYNAPSE_VERSION } as const;
